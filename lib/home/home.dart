              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    color: const Color.fromARGB(255,242,201,76,), //rgba(242, 201, 76, 1)
                    ...
                    (
                      ...
                      [
                        ...
                        (
                          width: double.infinity,
                          alignment: Alignment.centerLeft,
                          child: Text("Stay home\n we deliver",style: TextStyle(fontSize: 28,fontWeight: FontWeight.bold,color: Colors.white,),),
                        ),
                        ...
                        (
                          width: double.infinity,
                          alignment: Alignment.centerLeft,
                          child: Text("Any where... Any time!!",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold,color: Colors.white,),),
                        ),
                        Expanded(flex: 1, child: SizedBox()),
                      ],
                    ),
  ...
  Widget build(BuildContext context) 
  {
    ...
    (
      ...
      (
        ...
        height: 270,
        width: 200,
        decoration: BoxDecoration(border: Border.all(color: Colors.black, width: 0.5),borderRadius: BorderRadius.circular(10),),
        child: Column
        (
          children: 
          [
            ...
            (
              ...
              [
                ...
                (
                  ...
                  height: 100,
                  width: 100,
                  decoration: BoxDecoration(color: data[index]["backcolor"].withOpacity(0.3),borderRadius: BorderRadius.circular(50),),
                  child: Container
                  (
                    decoration: BoxDecoration(color: data[index]["backcolor"],borderRadius: BorderRadius.circular(40),),
                  ),
                ),
            ...
            (
              width: double.infinity,
              alignment: Alignment.centerLeft,
              child: Text("${data[index]["sub"]}",style: TextStyle(fontSize: 14, color: Colors.grey),),
            ),
            ...
            (
              ...
              (
                ...
                [
                  ...
                  (
                    alignment: Alignment.centerLeft,
                    child: Text("${data[index]["price"]}",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                  ),
