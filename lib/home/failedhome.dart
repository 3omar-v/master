...
//                               width: 93,
//                               height: 96,
//                               decoration: BoxDecoration(color: data[index]["color"].withOpacity(0.3), borderRadius: BorderRadius.circular(80),border: Border.all(color: Color.fromARGB(255, 229, 229, 229),width: 2)),
//                               margin: EdgeInsets.fromLTRB(0, 20, 0, 0),
//                               padding: EdgeInsets.all(10),
//                               child: Container
//                               (
//                                 padding: EdgeInsets.all(100),
//                                 decoration: BoxDecoration(color: data[index]["color"], borderRadius: BorderRadius.circular(60)),
//                               ),
//                             ),
...
//                           alignment: Alignment.topLeft,
//                           margin:EdgeInsets.all(20),
//                           child: Text("Banana", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold), ),
//                         ),
...
//                           child: Container
//                           (
//                             child: Text("by weight \$1.32 kg", style: TextStyle(fontSize: 12,color: Colors.grey),),
//                           ),
//                         ),
...
//                                 (
//                                   margin: EdgeInsets.all(20),
//                                   child: Text("\$1.32", style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
//                                 ),
